...
Unzip the lanman.1.0.8.1.zip file to a folder. Make this folder your current directory.
...
Set the compiler environment with vcvars32.bat. Unzip the lanman.1.0.8.1.zip file to an empty 
