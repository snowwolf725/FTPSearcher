...
Unzip the lanman.1.08.zip file to a folder. Make this folder to your current directory.
Type in 

	ppm install win32-lanman.5.6 --location=.

if you use perl 5.6 (type in perl -v to verify your perl version). To install an
ActivePerl 5.005_03 compatible version, you should use

	ppm install win32-lanman --location=.

To verify the installation, type in ppm query. The lanman module should appear in the
list.
...
Set the compiler environment with vcvars32.bat. Unzip the lanman.1.08.zip file to an empty 
...
Sitll one hint: don't build on a w2k machine. Use nt4 instead. If you build on w2k, the module 
