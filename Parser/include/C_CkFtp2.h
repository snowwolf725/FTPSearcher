...
void CkFtp2_getForcePortIpAddress(HCkFtp2 handle, HCkString retval);
void CkFtp2_putForcePortIpAddress(HCkFtp2 handle, const char *newVal);
void CkFtp2_getGreeting(HCkFtp2 handle, HCkString retval);
...
int CkFtp2_getSendBufferSize(HCkFtp2 handle);
void CkFtp2_putSendBufferSize(HCkFtp2 handle, int newVal);
void CkFtp2_getSessionLog(HCkFtp2 handle, HCkString retval);
void CkFtp2_getSocksHostname(HCkFtp2 handle, HCkString retval);
void CkFtp2_putSocksHostname(HCkFtp2 handle, const char *newVal);
void CkFtp2_getSocksPassword(HCkFtp2 handle, HCkString retval);
void CkFtp2_putSocksPassword(HCkFtp2 handle, const char *newVal);
int CkFtp2_getSocksPort(HCkFtp2 handle);
void CkFtp2_putSocksPort(HCkFtp2 handle, int newVal);
void CkFtp2_getSocksUsername(HCkFtp2 handle, HCkString retval);
void CkFtp2_putSocksUsername(HCkFtp2 handle, const char *newVal);
int CkFtp2_getSocksVersion(HCkFtp2 handle);
void CkFtp2_putSocksVersion(HCkFtp2 handle, int newVal);
...
BOOL CkFtp2_getUseEpsv(HCkFtp2 handle);
void CkFtp2_putUseEpsv(HCkFtp2 handle, BOOL newVal);
...
BOOL CkFtp2_NlstXml(HCkFtp2 handle, const char *pattern, HCkString outStr);
...
BOOL CkFtp2_SetRemoteFileDateTime(HCkFtp2 handle, SYSTEMTIME *dt, const char *remoteFilename);
...
const char *CkFtp2_forcePortIpAddress(HCkFtp2 handle);
...
const char *CkFtp2_greeting(HCkFtp2 handle);
...
const char *CkFtp2_nlstXml(HCkFtp2 handle, const char *pattern);
...
const char *CkFtp2_socksHostname(HCkFtp2 handle);
const char *CkFtp2_socksPassword(HCkFtp2 handle);
const char *CkFtp2_socksUsername(HCkFtp2 handle);
