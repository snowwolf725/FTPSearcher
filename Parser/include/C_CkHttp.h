...
void CkHttp_getLoginDomain(HCkHttp handle, HCkString retval);
void CkHttp_putLoginDomain(HCkHttp handle, const char *newVal);
...
BOOL CkHttp_getNegotiateAuth(HCkHttp handle);
void CkHttp_putNegotiateAuth(HCkHttp handle, BOOL newVal);
...
int CkHttp_getSendBufferSize(HCkHttp handle);
void CkHttp_putSendBufferSize(HCkHttp handle, int newVal);
BOOL CkHttp_getSendCookies(HCkHttp handle);
void CkHttp_putSendCookies(HCkHttp handle, BOOL newVal);
void CkHttp_getSocksHostname(HCkHttp handle, HCkString retval);
void CkHttp_putSocksHostname(HCkHttp handle, const char *newVal);
void CkHttp_getSocksPassword(HCkHttp handle, HCkString retval);
void CkHttp_putSocksPassword(HCkHttp handle, const char *newVal);
int CkHttp_getSocksPort(HCkHttp handle);
void CkHttp_putSocksPort(HCkHttp handle, int newVal);
void CkHttp_getSocksUsername(HCkHttp handle, HCkString retval);
void CkHttp_putSocksUsername(HCkHttp handle, const char *newVal);
int CkHttp_getSocksVersion(HCkHttp handle);
void CkHttp_putSocksVersion(HCkHttp handle, int newVal);
...
const char *CkHttp_loginDomain(HCkHttp handle);
...
const char *CkHttp_socksHostname(HCkHttp handle);
const char *CkHttp_socksPassword(HCkHttp handle);
const char *CkHttp_socksUsername(HCkHttp handle);
